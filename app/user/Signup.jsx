...
function Signup({setSignup}) {
  return (
    <div className={`absolute  z-40 top-0  w-[90%] flex flex-col h-[]`}>
      <div className="bg-white">
      <section className="flex flex-col items-center mb-8 p-3">

      <Image src={image} alt="logo" className="w-24 mb-1" />
      ...
      <div>
        <HiX size={20} className="fixed top-5 right-6 " onClick={()=>setSignup(false)} />
      </div>
        <form className=" flex flex-col justify-center items-center mb-7">
